...
Source path: `/fundamental/technique/blanch`
...
Color change science: raw vegetables' dull color is due to the layer of gas between the pigment and the skin. Blanching releases that gas, allowing pigment to reach the surface.
...
See [referenced recipe examples](../resources/recipe-examples.md#blanch).
