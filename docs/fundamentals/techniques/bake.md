...
Source path: `/fundamental/technique/bake`

Cooking food in an oven with medium temperatures.

## What are the fundamentals of baking?
...
See [referenced recipe examples](../resources/recipe-examples.md#bake).
