...
Source path: `/fundamental/technique/braise`
...
- Meat is braised to break down tough collagen into gelatin, which is juicy and unctuous.
...
See [referenced recipe examples](../resources/recipe-examples.md#braise).
