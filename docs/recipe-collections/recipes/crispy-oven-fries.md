...
Source path: `/recipe/crispy-oven-fries`

Better & easier than deep fried.

## Metadata

- Author: Ethan Chlebowski
- Date published: 2023-12-11T15:52:13Z
- Yield: 2-4 servings
- Time: 1 hr 15 min (PT1H15M)
- Category: Side
- Cuisine: American
- Keywords: Best oven method for fries, best alternative to deep frying, how to make crispy fries at home, the science of good french fries
- Tags: Bad Day, Level Up, Bake
- Image: `https://cdn.sanity.io/images/g1s4qnmz/production/ba9d3d0d5ff9a0f9f17f8e11df7e93b7f3806a48-1000x1000.jpg`
- Video: `https://www.youtube.com/watch?v=MvnYBCDaEKU`
...
Once the water has boiled, add the vinegar and a large pinch of salt, stirring to dissolve the salt. Add the potatoes to the water and boil for 8 minutes.

Note: The vinegar will slow down the breakdown of the potato pectin starch so the fries do not fall apart as easily.

Boiling the fries will gelate their exterior, which will give you much crispier results in the next steps.
...
Make sure the fries aren't overly crowded. They need space to properly dehydrate in the oven. Use 2 baking sheets if needed.
...
At this point, they should be browned and crispy, though it could take longer depending on the size of the fry, how crowded the pan is, or the amount of oil used.
