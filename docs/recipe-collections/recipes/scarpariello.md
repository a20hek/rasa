...
Source path: `/recipe/scarpariello`

It’s a hearty and crowd-pleasing dish.

## Metadata

- Author: Keith McBrayer
- Date published: 2024-04-03T18:52:42Z
- Yield: 4-6 servings
- Time: 1 hr 5 min (PT1H5M)
- Category: Dinner
- Cuisine: Italian
- Keywords: Scarpariello, Italian, chicken, sausage, peppers.
- Tags: Level Up, Party, I Got Time
- Image: `https://cdn.sanity.io/images/g1s4qnmz/production/7e0f34eb445764b82c0e66eacfd9d6386a15066d-3543x3543.jpg`

## Nutrition

- calories: 4549 calories
...
Heat a large sauté pan or braising pan over medium heat, and add enough olive oil to coat the bottom. In batches, sear the chicken pieces until the skin has picked up some browning color on all sides. Remove from the pan and set aside.
...
In the same pan, add the bell pepper and onion slices along with a sprinkle of salt. Sauté and scrape any browned fond on the bottom of the pan for 2-3 minutes, or until the vegetables begin to soften.

Add the garlic and bloom for another minute, or until fragrant. Add the jarred peppers to the mix (either drain them or just add them with their liquid if you want a brighter, brinier final fish).
