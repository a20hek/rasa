...
Source path: `/recipe/spaghetti-and-meatballs`

My take on the classic dish. 

## Metadata

- Author: Ethan Chlebowski
- Date published: 2025-09-08T18:55:20Z
- Yield: 4 servings
- Time: 1 hr 10 min (PT1H10M)
- Category: Main Course
- Cuisine: Italian
- Keywords: pasta, weeknight spaghetti and meatballs, easy dinner
- Tags: Level Up, Date Night, I Got Time
- Image: `https://cdn.sanity.io/images/g1s4qnmz/production/6c4912f6f1f45bb27fc54384c201d6b4fe931cac-2070x1384.png`
- Video: `https://www.youtube.com/watch?v=fjXHi3MFdtU`
...
- Garlic, 3 cloves
- Onions, 1/4
- Red Pepper Flakes, a spoonful
- Fresh oregano, a spoonful
- Salt, to taste
- Spaghetti, 454 g
...
As the butter melts, add in the garlic cloves followed by the spices. Let it bloom for several seconds before adding in the tomato paste.

Stir the sauce base together and then add the peeled tomatoes and onion.

Allow it to simmer covered for about an hour.
